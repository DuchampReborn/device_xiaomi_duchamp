...
# Engineer Mode
$(call inherit-product-if-exists, device/xiaomi/duchamp-engineering/device.mk)
...
# Thermal files
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/configs/thermals/,$(TARGET_COPY_OUT_ODM)/etc)
